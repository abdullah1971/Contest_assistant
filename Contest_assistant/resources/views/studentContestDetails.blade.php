...
@section('contest-related-navigation')
  ...
  {{-- <ul class="nav nav-sidebar">
    ...
    <li id="problem-set-nav" class="active" @yield('nav-contest-list')><a href="#problem-sets">Problem Set</a></li>
    ...
    <li id="editorial-nav" @yield('nav-add-contest')><a href="{{route('contest.create') }}">Editorial</a></li>
...
<div class="list-group">
    ...
    @foreach($problemSet as $singleProblem)
        ...
        <a style="text-decoration: none;" href="{{ route('student.problem_details',['id' => $singleProblem->id]) }}">

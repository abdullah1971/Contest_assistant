...
<body>
	...
	<div class="row">
		...
		<div class="col-sm-offset-1 col-sm-8">
			...
			<form method="post" action="{{ route('problem.singleProblemUpdateStore', ['id' => $problemSetInstancae->contest_id, 'number' => $problemSetInstancae->id]) }}" enctype="multipart/form-data">
				...
				<input type="hidden" name="contest_number" value="{{Request::segment(3)}}">
					...
					<div class="form-group {{ $errors->has('problem_name') ? 'has-error' : '' }}">
					    ...
					    <div class="col-sm-9">
					      <input type="text" class="form-control" id="problem_name" placeholder="problem name" name="problem_name" value="{{ $problemSetInstancae->problem_name }}">
					      	<br>
					    </div>
